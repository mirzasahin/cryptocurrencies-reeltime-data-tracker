    ...
    <div className="overflow-x-auto">
      <table className="min-w-full">
        <thead className="bg-gray-50">
          <tr>
            <th className="px-6 py-3 text-left text-xs font-bold text-gray-400 tracking-wider">Crypto</th>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-md text-gray-900 flex items-center">
                ...
                <div>
                  <div className="font-bold">
                    {item.symbol.toUpperCase()} <span className="font-medium text-gray-400">/ USDT</span>
                  </div>
                  <div>{item.name}</div>
                </div>
              </td>
              <td className="px-6 text-right py-4 whitespace-nowrap text-sm text-gray-600">
                <span className="font-bold text-lg">{formatNumberWithTwoDecimals(item.current_price)}</span>{" "}
                <span className="font-medium text-gray-400">USDT</span>
              </td>
              <td className="px-6 text-right py-4 whitespace-nowrap text-sm text-gray-600">
                <span className="font-bold text-lg">{formatNumber(item.market_cap)}</span>{" "}
                <span className="font-medium text-gray-400">USDT</span>
              </td>
              <td
